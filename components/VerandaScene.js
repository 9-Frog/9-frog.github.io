    ...
    useImperativeHandle(ref, () => {
        ...
        return {
            ...
            captureBlob: async (options) => {
                ...
                if (!blob) {
                    throw new Error('Could not capture the scene image.');
                }
                return blob;
            },
